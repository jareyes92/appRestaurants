    ...
    <View>
      {restaurants ? (
        <FlatList
          ...
          onEndReached={handleLoadMore} // esto permite q cuando llegue al final de la lista me pida los siguientes 8 restautantes
          onEndReachedThreshold={0.5} // pide los siguientes 8 restaurantes cuando este llegando al final pq su valor es 0.5
